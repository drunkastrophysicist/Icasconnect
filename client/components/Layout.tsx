...
export default function Layout({ children }: LayoutProps) {
  ...
  const reminders = [
    { id: 1, title: "Math Assignment Due", time: "Today, 5:00 PM" },
    { id: 2, title: "Physics Lab Report", time: "Tomorrow, 11:00 AM" },
    { id: 3, title: "Robotics Club Meeting", time: "Friday, 4:00 PM" },
  ];
              ...
              {user ? (
                <div className="flex items-center gap-2 relative">
                  <div className="relative">
                    <Button variant="ghost" size="icon" className="hidden md:flex" onClick={() => setShowReminders((v) => !v)}>
                      <Bell className="h-5 w-5" />
                    </Button>
                    {showReminders && (
                      <div ref={remindersRef} className="absolute right-0 mt-2 w-64 bg-background rounded-lg shadow-lg border border-border z-50 p-2">
                        <div className="text-sm font-bold mb-2 text-primary flex items-center gap-1">
                          <Bell size={16} /> Reminders
                        </div>
                        <ul className="flex flex-col gap-1">
                          {reminders.map(r => (
                            <li key={r.id} className="rounded bg-muted px-2 py-1 flex flex-col">
